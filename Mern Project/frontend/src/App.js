...
import AdminAccount from "./component/Admin/adminAccount"
...
import Model from "./ImageModel.js"
  ...
  return (
    ...
    <Router>
      <Header />
        ...
        <Route path="/checker" element={<Model/>}/>
      ...
      <Route path="/admin/account" isAdmin={true} element={<AdminAccount/>}/>
